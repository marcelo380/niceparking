  ...
  Widget build(BuildContext context) {
    return DataTable(
        ...
        columns: [
          ...
          DataColumn(
            label: Center(child: CustomTypography.title16('Tempo de uso.')),
          ),
        ],
        rows: reportParkingSlotsMobxCTRL.parkinReportList.map(
          (item) {
            return DataRow(
              cells: [
                DataCell(
                  Center(child: CustomTypography.body14('${item.placa}')),
                ),
                DataCell(
                  Center(
                ...
                DataCell(
                  Center(
                      child: CustomTypography.body14(item.dataSaida != null
                          ? DateFormat('dd/MM/yyyy hh:mm')
                ...
                DataCell(
                  Center(
                    child: CustomTypography.body14(
                      (item.dataEntrada != null && item.dataSaida != null)
